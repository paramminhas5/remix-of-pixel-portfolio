...
const SOLE: Level = {
  ...
  map: buildMap({
    width: 95, spawn: 2,
    npcGxs: [6, 24, 46, 68, 86],
    qBlock: 14,
    minigame: 58,
    secret: 80,
    coinTopGxs: [10, 18, 28, 36, 44, 52, 62, 72, 82, 90],
    coinMidGxs: [14, 22, 32, 40, 50, 60, 70, 78, 88],
    platforms: [[8, 5], [20, 5], [32, 6], [44, 5], [56, 6], [68, 5], [80, 6], [88, 5]],
  }),
  coins: [
    { gx: 10, gy: 3, skill: "CEO" }, { gx: 18, gy: 3, skill: "Fundraising · $795K" },
    { gx: 28, gy: 3, skill: "Brand building" }, { gx: 36, gy: 3, skill: "Retail ops" },
    { gx: 44, gy: 3, skill: "PR & Press" }, { gx: 52, gy: 3, skill: "Community · 350K" },
    { gx: 62, gy: 3, skill: "Live events" }, { gx: 72, gy: 3, skill: "Authentication" },
    { gx: 82, gy: 3, skill: "Streetwear" }, { gx: 90, gy: 3, skill: "Drops & hype" },
    { gx: 14, gy: 7, skill: "Storytelling at scale" }, { gx: 22, gy: 7, skill: "Influencer ops" },
    { gx: 32, gy: 7, skill: "Capital strategy" }, { gx: 40, gy: 7, skill: "DTC commerce" },
    { gx: 50, gy: 7, skill: "Brand × culture" }, { gx: 60, gy: 7, skill: "Viral content" },
    { gx: 70, gy: 7, skill: "Series A learnings" }, { gx: 78, gy: 7, skill: "Founder grit" },
    { gx: 88, gy: 7, skill: "Beautiful exits" },
  ],
  npcs: [
    ...
    { gx: 24, gy: 9, name: "Prabal Baghla", role: "Co-founder · Operations & retail", portrait: "founder", hue: 320, beat: "did",
    ...
    { gx: 46, gy: 9, name: "Rannvijay Singha", role: "Partner · Brand & culture", portrait: "celeb", hue: 0, beat: "did",
    ...
    { gx: 68, gy: 9, name: "What culture taught me", role: "Building a movement, not a store", portrait: "investor", hue: 340, beat: "learned",
    ...
    { gx: 86, gy: 9, name: "The Press", role: "What CNBC, YourStory & ET said", portrait: "fan", hue: 320, beat: "learned",
  ...
  clipping: { gx: 14, gy: 9, title: "Why SoleSearch still matters", source: "SoleSearch · 2020-2024 · CNBC-TV18",
  ...
  secret: { gx: 80, gy: 9, title: "Why we sold for parts",
  ...
  minigame: { gx: 58, gy: 9, id: "spot-fake", label: "Mini-game: real or fake?" },
